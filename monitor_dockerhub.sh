...
REPO_LIST=(alpine debian nginx nginx-tags webssh webssh-tags novnc novnc-tags turtleblocksjs turtleblocksjs-tags musicblocks musicblocks-tags sysmon sysmon-tags node node-tags)
